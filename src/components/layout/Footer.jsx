      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center mb-4">
          ...
          <div className="mb-4 sm:mb-0">
            <img src={footerlogo} alt="uifry" className="h-7 w-auto" />
          </div>
          ...
          <nav className="flex gap-4 sm:gap-6 text-sm sm:text-base">
            <Link
              to="/"
              className="text-gray-700 hover:text-[#1376F8] transition-colors font-medium"
            >
              Home
            </Link>
            <Link
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center text-xs sm:text-sm text-gray-600">
          ...
          <div className="flex gap-3">
            <a
              href="#"
              className="w-8 h-8 bg-[#011632] rounded-full flex items-center justify-center hover:bg-[#1376F8] transition-colors"
            >
              <svg
